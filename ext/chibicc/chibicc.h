...
void error_tok(const Token *tok, const char *fmt, ...) __attribute__((format(printf, 2, 3)));
void warn_tok(const Token *tok, const char *fmt, ...) __attribute__((format(printf, 2, 3)));
...
char *search_include_paths(const char *filename);
